...
If it is impossible to meet both the budget constraint and other travel constraints in the query exactly as specified, use the following guideline to guide your decision-making:
Aim to stay as close to the budget as possible but allow a slight budget overrun (up to 25%) if it helps to meet other constraints. 
